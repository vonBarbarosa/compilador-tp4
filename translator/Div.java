...
{
  /**
   * Verifica se a linha da quádrupla é uma operação de divisão.
   * 
   * @return resposta
   */
  ...
  public static void bothId()
  {
    ...
    if (x1 instanceof Integer && x2 instanceof Integer)
    {
      ...
      Integer div = Integer.parseInt(x1.toString())/Integer.parseInt(x2.toString());
      Translator.putInValues(Translator.quad[0], div);
      Translator.putInCodes(Translator.quad[0]); // Armazena a variável com o seu código
      passo3 = (Translator.labelCounter++) + ": "+Opcode.IDIV; // Divide os dois do topo da pilha
    ...
    else
    {
      ...
      Float div = Float.parseFloat(x1.toString())/Float.parseFloat(x2.toString());
      Translator.putInValues(Translator.quad[0], div);
      Translator.putInCodes(Translator.quad[0]); // Armazena a variável com o seu código
      passo3 = (Translator.labelCounter++) + ": "+Opcode.FDIV; // Divide os dois do topo da pilha
  ...
  public static void idAndIntConst()
  {
    ...
    {
      // Resultado da soma na variável inteira
      Integer div = Integer.parseInt(x1.toString())/x2;
      Translator.putInValues(Translator.quad[0], div);
      Translator.putInCodes(Translator.quad[0]); // Armazena a variável com o seu código
      passo3 = (Translator.labelCounter++) + ": "+Opcode.IDIV; // Divide os dois do topo da pilha
      passo4 = (Translator.labelCounter++) + ": "+Opcode.ISTORE+" "+Translator.varCode.get(Translator.quad[0]); // Armazena na variável
  ...
  public static void idAndFloatConst()
  {
    ...
    // Resultado da soma na variável float
    Float div = Float.parseFloat(x1.toString())/x2;
    Translator.putInValues(Translator.quad[0], div);
    Translator.putInCodes(Translator.quad[0]); // Armazena a variável com o seu código
    passo3 = (Translator.labelCounter++) + ": "+Opcode.FDIV; // Divide os dois do topo da pilha
    passo4 = (Translator.labelCounter++) + ": "+Opcode.FSTORE+" "+Translator.varCode.get(Translator.quad[0]); // Armazena na variável
  ...
  public static void intConstAndId()
  {
    ...
    {
      // Resultado da soma na variável inteira
      Integer div = x1/Integer.parseInt(x2.toString());
      Translator.putInValues(Translator.quad[0], div);
      Translator.putInCodes(Translator.quad[0]); // Armazena a variável com o seu código
      passo3 = (Translator.labelCounter++) + ": "+Opcode.IDIV; // Divide os dois do topo da pilha
      passo4 = (Translator.labelCounter++) + ": "+Opcode.ISTORE+" "+Translator.varCode.get(Translator.quad[0]); // Armazena na variável
  ...
  public static void floatConstAndId()
  {
    ...
    // Resultado da soma na variável float
    Float div = x1/Float.parseFloat(x2.toString());
    Translator.putInValues(Translator.quad[0], div);
    Translator.putInCodes(Translator.quad[0]); // Armazena a variável com o seu código
    passo3 = (Translator.labelCounter++) + ": "+Opcode.FDIV; // Divide os dois do topo da pilha
    passo4 = (Translator.labelCounter++) + ": "+Opcode.FSTORE+" "+Translator.varCode.get(Translator.quad[0]); // Armazena na variável
